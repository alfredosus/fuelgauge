 ...
 *******************************************************************************/
package ara.renault.com.fuel_gauge.views;
...
import ara.renault.com.fuel_gauge.R;
...
public class GaugeView extends View {
    ...
    private void readAttrs(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        mShowText = a.getBoolean(R.styleable.GaugeView_showWhatever, SHOW_TEXT);
    ...
    private Paint getDefaultOuterBorderPaint(int color) {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setStyle(Paint.Style.FILL);
    ...
    private Paint getDefaultInnerRimBorderLightPaint(int color) {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setStyle(Paint.Style.STROKE);
        paint.setColor(color);
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (color != 0) {
            canvas.drawOval(mOuterBorderRect,getDefaultInnerRimBorderLightPaint(color) );
        }
